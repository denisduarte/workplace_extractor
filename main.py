...
if __name__ == "__main__":
    ...
    parser.add_argument("--loglevel", choices=['NONE', 'DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL'],
                        default='WARNING', help="Set the logging level")
    args = parser.parse_args()

    wp_extractor = Extractor(args.token, args.config, args.export, args.hashtags, args.since, args.until, args.csv,
                             args.loglevel)
